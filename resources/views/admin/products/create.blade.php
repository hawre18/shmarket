                                    ...
                                    <div class="modal-body">
                                        <div data-scroll="true" data-height="600">
                                            ...
                                            <form method="post" action="\attributes-value">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-xl-3 col-lg-3 text-right col-form-label">نام مستعار محصول</label>
                                                    <div class="col-lg-9 col-xl-6">
                ...
                <div class="datatable datatable-bordered datatable-head-custom datatable-default datatable-primary datatable-loaded" id="kt_datatable" style="">
                    ...
                    <table class="datatable-table" style="display: block;">
                        ...
                        <tr class="datatable-row" style="left: 0px;">
                            ...
                            <th class="datatable-cell datatable-cell-sort"><span>کد محصول</span></th>
                            <th class="datatable-cell datatable-cell-sort"><span>نام محصول</span></th>
                        ...
                        @foreach($products as $product)
                            <tr class="datatable-row" style="left: 0px;">
                                ...
                                <span style="overflow: visible; position: relative;" class="text-center">
                                    <a href="{{route('products.edit',$product->id)}}" class="btn btn-sm btn-default btn-text-primary btn-hover-primary btn-icon mr-2" title="Edit details">
                                    ...
                                    <a href="{{route('products.delete',$product->id)}}" class="btn btn-sm btn-default btn-text-primary btn-hover-primary btn-icon text-center" title="Delete">
                                        <span class="svg-icon svg-icon-md">
                                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                    <rect x="0" y="0" width="24" height="24"></rect>

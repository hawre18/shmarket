                                            ...
                                            <div data-scroll="true" data-height="600">
                                                ...
                                                <form method="post" action="slides">
                                                    ...
                                                    <div class="form-group">
                                                        <label class="col-xl-3 col-lg-3 text-right col-form-label" for="title">عنوان اسلاید</label>
                                                    ...
                                                    <div class="form-group required">
                                                        <label for="photo" class="col-xl-3 col-lg-3 text-right col-form-label">گالری تصاویر</label>
                    ...
                    <div class="datatable datatable-bordered datatable-head-custom datatable-default datatable-primary datatable-loaded" id="kt_datatable" style="">
                        ...
                        <table class="datatable-table" style="display: block;">
                            ...
                            <tr class="datatable-row" style="left: 0px;">
                                ...
                                <th class="datatable-cell datatable-cell-sort"><span>عنوان</span></th>
                                <th class="datatable-cell datatable-cell-sort"><span>وضعیت نشر</span></th>
                                <th class="datatable-cell datatable-cell-sort"><span>عکس</span></th>
                            ...
                            @foreach($slides as $slide)
                                <tr class="datatable-row" style="left: 0px;">
                                    ...
                                    <td data-field="CompanyName" aria-label="Casper-Kerluke" class="datatable-cell">
                                        <span class="text-center">
                                            <a class="datatable-toggle-detail text-center">{{$slide->title}}</a>
                                        </span>
                                    </td>
                                    @if($slide->status==0)
                                        <td data-field="Status" width="15%" class="text-center datatable-cell"><span class="label label-danger">منتشر نشده</span></td>
                                    @else
                                        <td width="15%" data-field="Status" class="text-center"><span class="label label-success datatable-cell">منتشر شده</span></td>
                                    @endif
                                    @foreach($slide->photos as $photo)
                                        <td width="20%" data-field="photo" class="text-center img-circledatatable-cell">
                                            <img class="center-block img-responsive" width="20%" height="8%" src="{{$photo->path}}">
                                        </td>
                                    @endforeach
                                ...
                                <span style="overflow: visible; position: relative;" class="text-center">
                                    <a href="{{route('slides.edit',$slide->id)}}" class="btn btn-sm btn-default btn-text-primary btn-hover-primary btn-icon mr-2" title="Edit details">
                                    ...
                                    <a href="{{route('slides.delete',$slide->id)}}" class="btn btn-sm btn-default btn-text-primary btn-hover-primary btn-icon text-center" title="Delete">
                                        <span class="svg-icon svg-icon-md">
                                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                    <rect x="0" y="0" width="24" height="24"></rect>

                                        ...
                                        <div data-scroll="true" data-height="600">
                                            ...
                                            <form method="post" action="\cities">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-xl-3 col-lg-3 text-right col-form-label">شهر</label>
                                                    <div class="col-lg-9 col-xl-6">
                                                        <input class="form-control form-control-lg form-control-solid" value="{{old('name')}}" type="text" placeholder="شهر" name="name" />
                                                    </div>
                                                </div>
                                                <div class="separator separator-dashed my-10"></div>
                                                <div class="form-group row">
                                                    <label class="col-xl-3 col-lg-3 text-right col-form-label" for="attribute_group">استان</label>
                ...
                <div class="datatable datatable-bordered datatable-head-custom datatable-default datatable-primary datatable-loaded" id="kt_datatable" style="">
                    @if(Session::has('attribute-value_success'))
                        <div id="alert" class="alert alert-success">
                            <div>
                                {{Session('attribute-value_success')}}
                                {{Session()->flush()}}
                            </div>
                        </div>
                    ...
                    <table class="datatable-table" style="display: block;">
                        ...
                        <tr class="datatable-row" style="left: 0px;">
                            ...
                            <th class="datatable-cell datatable-cell-sort"><span>شهر</span></th>
                            <th data-field="FacultyAgent" class="datatable-cell datatable-cell-sort" ><span>استان</span></th>
                        ...
                        @foreach($cities as $city)
                            <tr class="datatable-row" style="left: 0px;">
                                ...
                                <span class="text-center">
                                    <div class="text-dark-75 font-weight-bolder font-size-lg mb-0">{{$city->name}}</div>
                                </span>
                                </td>
                                <td data-field="Status" data-autohide-disabled="false" aria-label="5" class="datatable-cell">
                                <span class="text-center">
                                    <span class="label label-lg font-weight-bold  label-light-danger label-inline">{{$city->province['name']}}</span>
                                </span>
                                </td>
                                ...
                                <span style="overflow: visible; position: relative;" class="text-center">
                                    <a href="{{route('cities.edit', $city->id)}}" class="btn btn-sm btn-default btn-text-primary btn-hover-primary btn-icon mr-2" title="Edit details">
                                    ...
                                    <a href="{{route('cities.delete', $city->id)}}" class="btn btn-sm btn-default btn-text-primary btn-hover-primary btn-icon text-center" title="Delete">
                                        <span class="svg-icon svg-icon-md">
                                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                    <rect x="0" y="0" width="24" height="24"></rect>

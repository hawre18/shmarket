                                        ...
                                        <div data-scroll="true" data-height="600">
                                            ...
                                            <form method="post" action="\attributes-value">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-xl-3 col-lg-3 text-right col-form-label">استان</label>
                ...
                <div class="datatable datatable-bordered datatable-head-custom datatable-default datatable-primary datatable-loaded" id="kt_datatable" style="">
                    ...
                    <table class="datatable-table" style="display: block;">
                        ...
                        <tr class="datatable-row" style="left: 0px;">
                            ...
                            <th class="datatable-cell datatable-cell-sort"><span>استان</span></th>
                        ...
                        @foreach($provinces as $province)
                            <tr class="datatable-row" style="left: 0px;">
                                ...
                                <span class="text-center">
                                    <div class="text-dark-75 font-weight-bolder font-size-lg mb-0">{{$province->name}}</div>
                                </span>
                                </td>
                                ...
                                <span style="overflow: visible; position: relative;" class="text-center">
                                    <a href="{{route('provinces.edit',$province->id)}}" class="btn btn-sm btn-default btn-text-primary btn-hover-primary btn-icon mr-2" title="Edit details">
                                    ...
                                    <a href="{{route('provinces.delete',$province->id)}}" class="btn btn-sm btn-default btn-text-primary btn-hover-primary btn-icon text-center" title="Delete">
                                        <span class="svg-icon svg-icon-md">
                                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                    <rect x="0" y="0" width="24" height="24"></rect>

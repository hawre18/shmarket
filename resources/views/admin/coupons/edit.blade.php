                                            ...
                                            <form method="post" action="\coupons\{{$coupon->id}}">
                                                ...
                                                <tr class="datatable-row" style="left: 0px;">
                                                    <td class="datatable-cell datatable-toggle-detail">
                                                        <input type="text" name="title" class="form-text form-control"  value="{{$coupon->title}}">
                                                    </td>
                                                    <td class="datatable-cell datatable-toggle-detail">
                                                        <input type="text" name="code" class="form-text form-control"  value="{{$coupon->code}}">
                                                    </td>
                                                    <td class="datatable-cell datatable-toggle-detail">
                                                        <input type="text" name="price" class="form-text form-control"  value="{{$coupon->price}}">
                                                    </td>
                                                    <td class="datatable-cell datatable-toggle-detail">
                                                        <input class="form-control" type="radio" name="status" value="1" @if($coupon->status==1) checked @endif>منتشر شده
                                                        <input  class="form-control"type="radio" name="status" value="0"@if($coupon->status==0) checked @endif>منتشر نشده
                                                    </td>
                                                    <td class="datatable-cell datatable-toggle-detail">

                                        ...
                                        <div data-scroll="true" data-height="600">
                                            ...
                                            <form method="post" action="\attributes-value">
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-xl-3 col-lg-3 text-right col-form-label">مقدار ویژگی</label>
                                                ...
                                                <div class="form-group row">
                                                    <label class="col-xl-3 col-lg-3 text-right col-form-label" for="attribute_group">لیست ویژگی ها</label>
                                                    <select name="attribute_group" class="form-control form-control-lg form-control-solid">
                ...
                <div class="datatable datatable-bordered datatable-head-custom datatable-default datatable-primary datatable-loaded" id="kt_datatable" style="">
                    ...
                    <table class="datatable-table" style="display: block;">
                        ...
                        <tr class="datatable-row" style="left: 0px;">
                            ...
                            <th data-field="FacultyAgent" class="datatable-cell datatable-cell-sort" ><span>ویژگی</span></th>
                        ...
                        @foreach($attributesvalue as $attribute)
                            <tr class="datatable-row" style="left: 0px;">
                                ...
                                <span class="text-center">
                                    <span class="label label-lg font-weight-bold  label-light-danger label-inline">{{$attribute->attributeGroup['title']}}</span>
                                </span>
                                </td>
                                ...
                                <span style="overflow: visible; position: relative;" class="text-center">
                                    <a href="{{route('attributes-value.edit',$attribute->id)}}" class="btn btn-sm btn-default btn-text-primary btn-hover-primary btn-icon mr-2" title="Edit details">
                                    ...
                                    <a href="{{route('attributes-value.delete',$attribute->id)}}" class="btn btn-sm btn-default btn-text-primary btn-hover-primary btn-icon text-center" title="Delete">
                                        <span class="svg-icon svg-icon-md">
                                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                    <rect x="0" y="0" width="24" height="24"></rect>

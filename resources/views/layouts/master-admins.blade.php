        ...
        <div class="d-flex flex-row flex-column-fluid page">
            <div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
                <div id="kt_header_mobile" class="header-mobile " >
                    <a href="index.html"><img alt="Logo" src="/assets/media/logos/logo-default.png" class="max-h-30px"/></a>
                    <div class="d-flex align-items-center">
                        <button class="btn p-0 burger-icon burger-icon-left ml-4" id="kt_header_mobile_toggle"></button>
                ...
                <div id="kt_header" class="header  header-fixed " >
                    <div class=" container ">
                        <div class="d-none d-lg-flex align-items-center mr-3">
                            <a href="index.html" class="mr-20"><img alt="Logo" src="assets/media/logos/logo-default.png" class="logo-default max-h-35px"/></a>
                        </div>
                                    ...
                                    <form method="get" class="quick-search-form">
                                        <div class="input-group rounded bg-light">
                                            ...
                                            <div class="input-group-append">
                                                <span class="input-group-text"><i class="quick-search-close ki ki-close icon-sm"></i></span>
                                            </div>
                                        </div>
                                    </form>
                                                        ...
                                                        <div class="navi navi-hover scroll my-4" data-scroll="true" data-height="300" data-mobile-height="200">
                                                            <a href="#" class="navi-item">
                                                                <div class="navi-link">
                                                                    ...
                                                                    <div class="navi-text">
                                                                        <div class="font-weight-bold">گزارش جدید دریافت شده است</div>
                                                                        <div class="text-muted">23 ساعت قبل</div>
                                                                    </div>
                                                                </div>
                                                            </a>
                                                            <a href="#" class="navi-item">
                                                                <div class="navi-link">
                                                                    ...
                                                                    <div class="navi-text">
                                                                        <div class="font-weight-bold">گزارش مالی تهیه شده است</div>
                                                                        <div class="text-muted">25 ساعت قبل</div>
                                                                    </div>
                                                                </div>
                                                            </a>
                                                            <a href="#" class="navi-item">
                                                                <div class="navi-link">
                                                                    ...
                                                                    <div class="navi-text">
                                                                        <div class="font-weight-bold">سفارش جدید دریافت شده است</div>
                                                            ...
                                                            <a href="#" class="navi-item">
                                                                <div class="navi-link">
                                                                    ...
                                                                    <div class="navi-text">
                                                                        <div class="font-weight-bold">مشتری جدید ثبت شده است</div>
                                                                        <div class="text-muted">3 ساعت قبل</div>
                                                                    </div>
                                                                </div>
                                                            </a>
                                                            <a href="#" class="navi-item">
                                                                <div class="navi-link">
                                                                    ...
                                                                    <div class="navi-text">
                                                                        <div class="font-weight-bold">اپلیکیشن تایید شده است</div>
                                                                         <div class="text-muted">3 ساعت قبل</div>
                                                                    </div>
                                                                </div>
                                                            </a>
                                                            <a href="#" class="navi-item">
                                                                <div class="navi-link">
                                                                    ...
                                                                    <div class="navinavinavi-text">
                                                                        <div class="font-weight-bold">پرونده جدید بارگذاری شد</div>
                                                                        <div class="text-muted">5 ساعت قبل</div>
                                                                    </div>
                                                                </div>
                                                            </a>
                                                            <a href="#" class="navi-item">
                                                                <div class="navi-link">
                                                                    ...
                                                                    <div class="navi-text">
                                                                        <div class="font-weight-bold">بازخورد کاربر جدید دریافت شد</div>
                                                                        <div class="text-muted">8 ساعت قبل</div>
                                                                    </div>
                                                                </div>
                                                            </a>
                                                            <a href="#" class="navi-item">
                                                                <div class="navi-link">
                                                                    ...
                                                                    <div class="navi-text">
                                                                        <div class="font-weight-bold">سیستم راه اندازی مجدد با موفقیت انجام شد</div>
                                                                        <div class="text-muted">12 ساعت قبل</div>
                                                                    </div>
                                                                </div>
                                                            </a>
                                                            <a href="#" class="navi-item">
                                                                <div class="navi-link">
                                                                    ...
                                                                    <div class="navi-text">
                                                                        <div class="font-weight-bold">سفارش جدید درج شده است</div>
                                                                        <div class="text-muted">15 ساعت قبل</div>
                                                                    </div>
                                                                </div>
                                                            </a>
                                                            <a href="#" class="navi-item">
                                                                <div class="navi-link">
                                                                    ...
                                                                    <div class="navi-text">
                                                                        <div class="font-weight-bold">جلسه شرکت لغو شد</div>
                                                                        <div class="text-muted">19 ساعت قبل</div>
                                                                    </div>
                                                                </div>
                                                            </a>
                                                            <a href="#" class="navi-item">
                                                            ...
                                                            <a href="#" class="navi-item">
                                                                <div class="navi-link">
                                                                    ...
                                                                    <div class="navi-text">
                                                                        <div class="font-weight-bold">نظر مشتری جدید دریافت شد</div>
                                                                        <div class="text-muted">2 چند روز قبل</div>
                                                                    </div>
                                                                </div>
                                                            </a>
                                                            <a href="#" class="navi-item">
                                                                <div class="navi-link">
                                                                    ...
                                                                    <div class="navi-text">
                                                                        <div class="font-weight-bold">مشتری جدید ثبت شده است</div>
                                                                        <div class="text-muted">3 چند روز قبل</div>
                                                                    </div>
                                                                </div>
                                                            </a>
                                                        </div>
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
                                            <div class="d-flex flex-column flex-center py-10 bg-dark-o-5 rounded-top bg-light">
                                                <h4 class="text-dark font-weight-bold">اقدامات سریع</h4>
                                                ...
                                                <div class="scroll scroll-push" data-scroll="true" data-height="250" data-mobile-height="200" >
                                                    <div class="d-flex align-items-center justify-content-between p-8">
                                                        <div class="d-flex flex-column mr-2">
                                                            ...
                                                            <span class="text-muted">بهترین وسایل آشپزخانه سال 2020</span>
                                                    ...
                                                    <div class="separator separator-solid"></div>
                                                        <div class="d-flex align-items-center justify-content-between p-8">
                                                            <div class="d-flex flex-column mr-2">
                                                                <a href="#" class="font-weight-bold text-dark-75 font-size-lg text-hover-primary">پاک کننده هوشمند</a>
                                                                <span class="text-muted">ابزار هوشمند برای پخت و پز</span>
                                                                <div class="d-flex align-items-center mt-2">
                                                        ...
                                                        <div class="d-flex align-items-center justify-content-between p-8">
                                                            <div class="d-flex flex-column mr-2">
                                                                <a href="#" class="font-weight-bold text-dark-75 font-size-lg text-hover-primary">دوربین</a>
                                                                <span class="text-muted">دوربین حرفه ای برای عکس</span>
                                                                <div class="d-flex align-items-center mt-2">
                                                        ...
                                                        <div class="d-flex align-items-center justify-content-between p-8">
                                                            <div class="d-flex flex-column mr-2">
                                                                <a href="#" class="font-weight-bold text-dark text-hover-primary">چاپ 4D</a>
                                                                <span class="text-muted">ساخت اشیاء منحصر به فرد</span>
                                                                <div class="d-flex align-items-center mt-2">
                                            ...
                                            <div class="navi navi-spacer-x-0 pt-5">
                                                <a href="custom/apps/user/profile-1/personal-information.html" class="navi-item px-8">
                                                    <div class="navi-link">
                                                        ...
                                                        <div class="navi-text">
                                                            <div class="font-weight-bold">پروفایل من</div>
                                                            <div class="text-muted">تنظیمات اکانت
                                                ...
                                                <a href="custom/apps/user/profile-3.html"  class="navi-item px-8">
                                                    <div class="navi-link">
                                                        ...
                                                        <div class="navi-text">
                                                            <div class="font-weight-bold">پیام های من</div>
                                                            <div class="text-muted">صندوق پیام ها و کارها</div>
                                                        </div>
                                                    </div>
                                                </a>
                                                <a href="custom/apps/user/profile-2.html"  class="navi-item px-8">
                                                    <div class="navi-link">
                                                        ...
                                                        <div class="navi-text">
                                                            <div class="font-weight-bold">فعالیت های من</div>
                                                            <div class="text-muted">لاگ ها و اعلان ها</div>
                                                        </div>
                                                    </div>
                                                </a>
                                                <a href="custom/apps/userprofile-1/overview.html" class="navi-item px-8">
                                                    <div class="navi-link">
                                                        ...
                                                        <div class="navi-text">
                                                            <div class="font-weight-bold">کارهای من</div>
                                                            <div class="text-muted">اخرین کارها و پروژه ها</div>
                                                        </div>
                                                    </div>
                                                </a>

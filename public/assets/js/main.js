...
product_4.slick({
    ...
    slidesToScroll: 1,
    autoplay: false,
    prevArrow: '<button type="button" class="slick-prev"> قبلی </button>',
    nextArrow: '<button type="button" class="slick-next">بعدی</button>',
    responsive: [
        {
            breakpoint: 1199,
            settings: {
...
product_4.slick({
    ...
    slidesToScroll: 1,
    autoplay: false,
    prevArrow: '<button type="button" class="slick-prev"> بعدی </button>',
    nextArrow: '<button type="button" class="slick-next">قبلی</button>',
    responsive: [
        {
            breakpoint: 1199,
            settings: {
...
$( "#price-slider" ).slider({
  ...
  $( "#min-price" ).val( $( "#price-slider" ).slider( "values", 0 ) + ' تومان ' );
  $( "#max-price" ).val( $( "#price-slider" ).slider( "values", 1 ) +  ' تومان ' );
